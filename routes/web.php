...
Route::middleware('auth')->group(function() {
    ...
    Route::post('/confirm/checkout', [TransactionController::class, 'confirm_checkout'])->name('transaction.confirm_checkout');
    Route::get('/payment', [TransactionController::class, 'payment'])->name('transaction.payment');
    Route::post('/confirm/payment', [TransactionController::class, 'confirm_payment'])->name('transaction.confirm_payment');
